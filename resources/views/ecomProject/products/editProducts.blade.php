                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="name" id="name" value="{{ $product->name }}" placeholder="Enter Product Name">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" min='0' max='5' step='0.5' class="form-control" required name="rating" id="rating" value="{{ $product->rating }}" placeholder="Enter Value">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" required name="price" id="price" value="{{ $product->price }}" placeholder="Enter Actual Price">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="cost_price">Cost Price<span class="text-danger"> *</span></label>
                                            <input type="number" class="form-control" required name="cost_price" id="cost_price" value="{{ $product->cost_price }}" placeholder="Enter Cost Price">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" required name="discount_price" value="{{ $product->discount_price }}" id="discount_price" placeholder="Enter Cost Price">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" required placeholder="Description" id="short_description" name="short_description" rows="3">{{ $product->short_description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>

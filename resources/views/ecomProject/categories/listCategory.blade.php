          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title pl-5" style="line-height: 60px;">CATEGORIES</h3>
                <a href="{{ route('categories.create') }}" class="btn bg-gradient-primary btn-lg float-right mx-3"><b>ADD</b></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
    ...
    <script type="text/javascript">
        ...
        function deleteBtn(id){
            ...
            if (result.isConfirmed) {
                ...
                window.location.href="{{ route('categories.delete','') }}"+"/"+id;
            } else if (

            ...
            <div class="card-body">
                <form action="{{ route('users.update', $users->id) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="password" class="form-control" name="password" value="{{ $users->password }}" required>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <!-- textarea -->
                    ...
                    <div class="mt-5 row">
                        ...
                        <div class="col-4 offset-md-4">
                            <input type="submit" value="UPDATE" onclick="update();" class="btn btn-lg btn-success ml-3">
                        </div>
                    </div>
                </form>
            </div>

          ...
          <div class="card shadow-lg">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="{{ route('brands.index') }}" class="btn btn-lg btn-primary">LIST</a>
            ...
            <div class="card-body">
                <form action="javascript:void(0);" id="form" onsubmit="formValidate();">
                    ...
                    <div class="form-group form-row">
                        ...
                        <input type="text" id="slug" class="form-control" name="slug" value="">
                        <div class="invalid-feedback">
                            <h5>Enter Slug!</h5>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 row">
                        <div class="col-4 offset-md-4">
                            <input type="submit" value="CREATE" class="btn btn-lg btn-success ml-3">
                        </div>
                    </div>
                </form>
            </div>
